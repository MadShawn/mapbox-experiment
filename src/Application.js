...
App.Util = {
  ...
  /**
   * 根据登录的地区，获取服务地址的配置信息
   * @param  {String} accessType 登录的地区
   * @return {Object} 服务地址配置信息
   */
  getServiceConfig(accessType) {
    return {
      ...App.Config.services,
      ...serviceList[accessType]
    };
  },
  /**
   * 从url地址中获取拼接的参数值
   ...
   * @author ChenXiao
   * @date   2019-3-7
   * @return {Boolean} 是否进入了工单
   */
  testWorkerOrder() {
    if (!App.Temp.WorkOrder) {
      return false;
    }
